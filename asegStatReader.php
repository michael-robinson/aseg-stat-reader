...
<?php
	...
	// This finds the largest value in the volume column which is used for making the bar graphs later
	$maxVolume = 0;
	for($i = 1; $i < count($dataTable); $i++)
		{
			if($dataTable[$i][2] > $maxVolume)
				{
					$maxVolume = $dataTable[$i][2];
				}
		}
	...
	$jsMaxVolume = json_encode($maxVolume);
...
<style>
 ...
 <script>
 	...
 	// these grap the data an maxVolume variable from the php. 
	sortedTable = <?= $jsSortedTable?>;
	maxVolume = <?= $jsMaxVolume?>;
	...
	document.write("<table>");
		document.write("<caption style='padding-top: 15px;'> Left Hemisphere </caption>");
			...
			document.write("<tr>");
				...
				document.write("<th> Volume (mm<sup>3</sup>) </th>");	
			document.write("</tr>");
	...
	for(i = 1; i < sortedTable[0].length; i++)		
		{
			...
			document.write("<tr>");
				...
				document.write("<td>" + sortedTable[0][i][3] + "</td>");
				document.write("<td>");
				document.write("<div class='barBackground'>");
				document.write("</div>");
				document.write("<div class='bar' style='width: " + getPercentage(sortedTable[0][i][3]) +"';>");
				document.write("</div>");
				document.write("</td>");
			document.write("</tr>");
		}			
	...
	for(i = 1; i < sortedTable[1].length; i++)		
		{
			document.write("<tr>");
				...
				document.write("<td>" + sortedTable[1][i][3] + "</td>");
				document.write("<td>");
				document.write("<div class='barBackground'>");
				document.write("<div class='bar' style='width: " + getPercentage(sortedTable[1][i][3]) +"';>");
	...
	for(i = 1; i < sortedTable[2].length; i++)		
		{
			document.write("<tr>");
				...
				document.write("<td>" + sortedTable[2][i][3] + "</td>");
				document.write("<td>");
				document.write("<div class='barBackground'>");
				document.write("<div class='bar' style='width: " + getPercentage(sortedTable[2][i][3]) +"';>");
				document.write("</td>");
				document.write("</div>");
				document.write("</div>");
			document.write("</tr>");
